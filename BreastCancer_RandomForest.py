...
# Headers
###################################################
HEADERS = ["CodeNumber","ClumpThickness","UniformityCellSize","UniformityCellShape","MarginalAdhesion","SingleEpithelialCellSize","BareNuclei","BlandChromatin",
...
def data_file_to_csv():
    ...
    # Save the loaded dataset intoo csv format
...
def main():
    ...
    # Get random forest classifier instance
